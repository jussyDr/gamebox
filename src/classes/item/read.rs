...
impl Item {
    ...
    fn read_chunk_2e002019<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
    ...
    fn read_chunk_2e00201c<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
        d.u32()?; // 5
    ...
    fn read_chunk_2e00201f<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
...
impl ItemPlacementParam {
    ...
    fn read_chunk_2e020005<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
...
impl ItemEntityModel {
    fn read_chunk_2e027000<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
        d.u32()?; // 4
...
impl ItemEntityModelEdition {
    fn read_chunk_2e026000<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
        d.u32()?; // 7
...
impl Crystal {
    fn read_chunk_09003003<R: Read + Seek, I: IdStateRef, N: NodeStateMut>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
        d.u32()?; // 2
