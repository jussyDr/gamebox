...
impl Collector {
    pub(crate) fn read_chunk_2e001003<'a, R: Read, I: IdStateRef<'a>, N>(
        &mut self,
    ...
    pub(crate) fn read_chunk_2e001009<'a, R: Read, I: IdStateRef<'a>, N>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
        d.string()?; // "Items"
    ...
    pub(crate) fn read_chunk_2e00100b<'a, R: Read, I: IdStateRef<'a>, N>(
        &mut self,
        d: &mut Deserializer<R, I, N>,
    ) -> Result<()> {
