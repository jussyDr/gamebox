...
impl Class for BlockInfoClipVertical {
    const CLASS_ID: u32 = 0x03340000;
}
...
mod read {
    ...
    use super::BlockInfoClipVertical;

    impl Readable for BlockInfoClipVertical {}

    impl readable::Sealed for BlockInfoClipVertical {}

    impl HeaderChunks for BlockInfoClipVertical {
    ...
    impl ReadBody for BlockInfoClipVertical {
    ...
    impl BodyChunks for BlockInfoClipVertical {
