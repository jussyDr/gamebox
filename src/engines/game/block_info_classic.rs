        ...
        [
            BodyChunkEntry {
                ...
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e001009(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e00100b,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e00100b(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e00100c,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e00100c(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e00100d,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e00100d(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e001010,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e001010(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e001011,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e001011(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x2e001012,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    Collector::read_chunk_2e001012(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e00f,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_15(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e013,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_19(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e017,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_23(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e020,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_32(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e023,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_35(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e026,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_38(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e027,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_39(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e028,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_40(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e029,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_41(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e02a,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_42(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e02b,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_43(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e02c,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_44(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e02f,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_47(n.deref_mut(), r)
                }),
            },
            BodyChunkEntry {
                id: 0x0304e031,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfo::read_chunk_49(n.deref_mut(), r)
                }),
            },
        ]
        .into_iter()
...
impl BlockInfo {
    ...
    fn read_chunk_23<R: Read, I, N>(&mut self, r: &mut Reader<R, I, N>) -> Result<()> {
        r.u32()?; // 0

        Ok(())
    }

    fn read_chunk_32<R: Read, I, N>(&mut self, r: &mut Reader<R, I, N>) -> Result<()> {
        r.u32()?; // 8
        r.u32()?; // 0xffffffff
        r.u32()?; // 0xffffffff
        r.u32()?; // 0xffffffff
    ...
    fn read_chunk_35<R: Read, I, N: NodeStateMut>(
        ...
        read_body_chunks(&mut BlockInfoVariantGround::default(), r)?;
        read_body_chunks(&mut BlockInfoVariantGround::default(), r)?;
...
impl BlockInfoVariant {
    ...
    fn read_chunk_5<R: Read, I, N: NodeStateMut>(&mut self, r: &mut Reader<R, I, N>) -> Result<()> {
        r.u32()?; // 3
        r.u32()?; // 1
        if r.bool32()? {
            r.internal_node_ref::<BlockInfoMobil>()?;
        }
        r.u32()?; // 0xffffffff
        r.u32()?; // 0xffffffff
        r.u32()?; // 0xffffffff
    ...
    fn read_chunk_8<R: Read, I, N: NodeStateMut>(&mut self, r: &mut Reader<R, I, N>) -> Result<()> {
        r.u32()?; // 2
        if r.bool32()? {
            r.internal_node_ref::<BlockUnitInfo>()?;
        }
        r.u32()?; // 0
        r.u32()?; // 0
        r.u32()?; // 0
    ...
    fn read_chunk_13<R: Read, I, N>(&mut self, r: &mut Reader<R, I, N>) -> Result<()> {
        r.u32()?; // 1
        r.u32()?; // 0xffffffff
    ...
    fn body_chunks() -> impl Iterator<Item = BodyChunkEntry<Self, R, I, N>> {
        [
            BodyChunkEntry {
                id: 0x0315b002,
                read_fn: BodyChunkReadFn::Normal(|n: &mut Self, r| {
                    BlockInfoVariant::read_chunk_2(n, r)
                }),
            },
            BodyChunkEntry {
                id: 0x0315b003,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_3(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b004,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_4(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b005,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_5(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b006,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_6(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b007,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_7(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b008,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_8(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b009,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_9(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b00a,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_10(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b00b,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_11(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315b00d,
                read_fn: BodyChunkReadFn::Normal(|n, r| BlockInfoVariant::read_chunk_13(n, r)),
            },
            BodyChunkEntry {
                id: 0x0315c001,
...
impl<R: Read, I, N> BodyChunks<R, I, N> for BlockUnitInfo {
    ...
    fn body_chunks() -> impl Iterator<Item = BodyChunkEntry<Self, R, I, N>> {
        [
            ...
            BodyChunkEntry {
                id: 0x0303600d,
                read_fn: BodyChunkReadFn::Normal(|n, r| Self::read_chunk_13(n, r)),
            },
        ]
        .into_iter()
    }
