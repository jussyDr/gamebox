use crate::{engines::game_data::collector::Collector, Class};
...
mod read {
    ...
    impl BlockInfo {
        ...
        fn read_chunk_35(
            ...
            let _variant_base_ground = BlockInfoVariantGround::read_from_body(r)?;
            let _variant_base_air = BlockInfoVariantAir::read_from_body(r)?;
        ...
        fn read_chunk_39(
            ...
            let _additional_variants_ground =
